...
# -*- coding: utf-8 -*-
#
# mct documentation build configuration file, created by
...
mock_modules = ['pyopencl', 'PyQt5', 'matplotlib', 'mpl_toolkits', 'mdt', 'mot']
...
def get_cli_doc_items():
    ...
    for file in sorted(glob.glob('../mct/cli_scripts/*.py')):
        ...
        if command_class_name is not None:
            item = dedent("""
                ...
                .. argparse::
                   :ref: mct.cli_scripts.{module_name}.get_doc_arg_parser
                   :prog: {command_name}
...
exclude_patterns = ['_build', 'auto_gen_cli_index.rst']
...
intersphinx_mapping = {
    ...
    'mdt': ('http://maastrichtdiffusiontoolbox.readthedocs.io/en/latest/', None),
}
